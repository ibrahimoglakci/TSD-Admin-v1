	   ...
	   if($_POST)
	   {
         ...
         $url=$VT->filter($_POST["url"]);
			   $sirano=$VT->filter($_POST["sirano"]);
				   ...
				   $yukle=$VT->upload("resim","assets/images/banner/");
				   if($yukle!=false)
				   {
       ...
       <div class="card-body card card-primary">
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                <label>Sıra No</label>
                <input type="number" class="form-control" placeholder="Sıra No ..." name="sirano" style="width:100px;" value="<?php $sirano=$VT->IDGetir("banner"); 
                if($sirano!=false)
                {
                  echo $sirano;
                }
