	   ...
	   if($_POST)
	   {
         ...
         if(!empty($_POST["indirimlifiyat"]))
         {
          ...
          if(!empty($_POST["indirimlikurus"])){$indirimlikurus=$_POST["indirimlikurus"];}else{$indirimlikurus="0";}
				   ...
				   $yukle=$VT->upload("resim","assets/images/urunler/");
				   if($yukle!=false)
				   {
         ...
         <div class="card-body card card-primary">
              <div class="row">
               ...
               <div class="col-md-12">
                <div class="form-group">
                <label>Sıra No</label>
                <input type="number" class="form-control" placeholder="Sıra No ..." name="sirano" style="width:100px;" value="<?php $sirano=$VT->IDGetir("urunler"); 
                if($sirano!=false)
                {
                  echo $sirano;
                }
          ...
          <div class="col-md-12" style="margin-bottom: 20px;">
            <a class="btn btn-info varyasyonEkleme" style="color:#fff; float: right;"><i class="fa fa-plus"></i> Varyasyon Ekle</a>
            <style type="text/css">
              .varyasyonGrup h2{background: #eee; border: 1px solid #ddd; padding: 3px; font-size: 16px; display: block; overflow: hidden; }
              ...
              .varyasyonGrup ul li{padding: 3px; border-bottom: 1px solid #ddd; padding-bottom: 8px;}
