    ...
    <section class="content">
     ...
     ?>
       ...
       <div class="card-body card card-primary">
            ...
            <div class="col-md-8 stokDurum">
                <div class="form-group">
                  <div class="durumlar" style="float: right; margin-top: 10px;">
                    <label style="margin-right: 12px;"><i class="fas fa-square" style="color: #c0392b"></i> Stok durumu az</label> 
                    <label style="margin-right: 12px;"><i class="fas fa-square" style="color: #f39c12"></i> Stok durumu normal</label> 
                    <label><i class="fas fa-square" style="color: #28a745"></i> Stok durumu iyi</label>  
                  </div>
              ...
              if($varyasyonlar!=false)
              {
                ...
                switch ($toplamvaryasyonSayisi) {
                    ...
                    if($kontrol!=false)
                    {
                      for($i=0;$i<count($kontrol);$i++)
                      {
                       ...
                       if($varyasyonStoklari!=false)
                       {
                        ...
                        if($varyasyonStoklari[0]["stok"]<10)
                        {
                          $arkaplanrengi="#c0392b";
                        }
                        else if($varyasyonStoklari[0]["stok"]>10 && $varyasyonStoklari[0]["stok"]<20)
                        {
                          $arkaplanrengi="#f39c12";
                        }
                        else if($varyasyonStoklari[0]["stok"]>20)
                        {
                          $arkaplanrengi="#32ff7e";
                        }
                  ...
                  case 2:
                    ...
                    if($kontrol!=false && $kontrol!=false)
                    {
                      for($i=0;$i<count($kontrol);$i++)
                      {
                        $secenekID=$kontrol[$i]["ID"];
                      ...
                      for($y=0;$y<count($kontrol2);$y++)
                      {
                       ...
                       if($varyasyonStoklari!=false)
                       {
                        ...
                        {
                          $arkaplanrengi="#E38B29";
                        }
                        else if($varyasyonStoklari[0]["stok"]>20)
                        {
                          $arkaplanrengi="#28a745";
                        }
         ...
         <div class="col-md-12">
            <div class="col-md-12">
                <div class="form-group">
                <button type="submit" class="btn btn-block btn-primary">Ürün Stoklarını Güncelle</button>
                </div>
            </div>
          </div>
